 ...
 * @author FATIMA
 */
public class TelaListaDiscente extends javax.swing.JFrame {

    /**
     * Creates new form TelaListaDiscente
     */
    public TelaListaDiscente() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        org.jdesktop.swingbinding.JTableBinding jTableBinding = org.jdesktop.swingbinding.SwingBindings.createJTableBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, discentesList, jTable2);
        org.jdesktop.swingbinding.JTableBinding.ColumnBinding columnBinding = jTableBinding.addColumnBinding(org.jdesktop.beansbinding.ELProperty.create("${idDi}"));
        ...
        jLabel7.setText("Registro de Alunos");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaListaDiscente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaListaDiscente().setVisible(true);
            }
        });
    }
